...
// MapIndexer The mapping function is called once for each piece of the input.
// In this framework, the key is the name of the file that is being processed,
// and the value is the file's contents. The return value should be a slice of
// key/value pairs, each represented by a mr.KeyValue.
func MapIndexer(document string, value string) (res []mr.KeyValue) {
...
// ReduceIndexer The reduce function is called once for each key generated by Map, with a
